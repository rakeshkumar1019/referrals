...
const SearchBarWithDropdown = () => {
  ...
  return (
    <form className="relative mx-auto w-full max-w-7xl px-4 py-4">
      <div className="flex ">
        <button
          id="dropdown-button"
          onClick={toggleDropdown}
          className={`flex-shrink-0 sm:30 lg:w-44 z-10 h-fit inline-flex items-center py-2.5 px-4 text-sm font-medium text-center text-gray-900 bg-gray-100 border border-gray-300 rounded-l-lg hover:bg-gray-200 focus:ring-4 focus:outline-none focus:ring-gray-100  ${
        ...
        <div
          ref={dropdownRef}
          className={`absolute mt-10 sm:w-35 lg:w-44 ${
